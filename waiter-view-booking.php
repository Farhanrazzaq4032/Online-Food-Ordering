...
<div class="content-wrapper">
    ...
    if (isset($_GET['booking_id'])) {
        $booking_order_id = $_GET['booking_id'];
        $cust_query = "SELECT * FROM booking_order WHERE booking_order_id ='$booking_order_id' LIMIT 1";
        $cust_query_run = mysqli_query($con, $cust_query);

        //  order table query 
        $odr_query = "SELECT * FROM order_details WHERE booking_order_id ='$booking_order_id'";
    ...
    ?>
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Booking Id# <?php echo $row['booking_order_id']; ?></h1>
                        </div>
                    </div>
                </div>
