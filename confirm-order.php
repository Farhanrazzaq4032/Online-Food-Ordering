                  ...
                  <tbody>
                    ...
                    ?>
                            <tr>
                              ...
                              <td>
                                <a href="confirm-view-order.php?order_id=<?= $row['order_id']; ?>" class="btn btn-light btn-sm">View</a>
                                <button type="submit" name="confirmOkBtn" class="btn btn-success btn-sm" value="<?=$row['order_id']; ?>">Ok</button>
                              </td>
                            </tr>
                      <?php
                          }
